...
void TestDatabase() {
  ...
  // Add 2 - Del 1 - Add deleted again
  {
    ...
    db.Add(d, "e1");
    size_t size_ = 2;
    AssertEqual(db.FindIf(empty_predicate).size(), size_, "Db Add2-Del-Add 2");
  }
  ...
  // Add
  {
    ...
    size_t size_ = 1;
    AssertEqual(db.FindIf(predicate).size(), size_, "Db Add Duplicates 1");
  }
  ...
  // Find
  {
    ...
    size_t size_ = 2;
    AssertEqual(db.FindIf(predicate).size(), size_, "Db Find 1");
  }
  {
    Database db;
    db.Add({2019, 1, 1}, "e1");
    ...
    size_t size_ = 4;
    AssertEqual(db.FindIf(predicate).size(), size_, "Db Find 2");
  }
  {
    Database db;
    db.Add({2019, 1, 1}, "e1");
    ...
    db.Add({2018, 1, 7}, "e4");
    size_t size_ = 4;
    AssertEqual(db.FindIf(empty_predicate).size(), size_, "Db Find 3");
  }
  {
    Database db;
    db.Add({2019, 1, 1}, "e1");
    ...
    size_t size_ = 1;
    AssertEqual(db.FindIf(predicate).size(), size_, "Db Find 4");
  }

  {
    ...
    size_t size_ = 2;
    AssertEqual(db.FindIf(predicate).size(), size_ , "Db Find 5");
  }
